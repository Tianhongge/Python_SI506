...
# TODO Add Tesla vehicles to list (one at a time)
...
print(f"\n2.2.1 Tesla vehicles = {tesla_vehicles}")
...
# TODO Implement for loop and add vehicle(s) to accumulator list
...
for element in elec_vehicles[1:]:
    ...
    print(vehicle)
# TODO Implement loop / if statement

print(f"\nCh 03 EVs (range > 250 mi) = {hi_range_elec_vehicles}")

# BONUS: look up index values using headers
hi_range_elec_vehicles = [] # accumulator

# TODO Implement loop / if statement (look up indexes using headers)

print(f"\nCh 03 Bonus: EVs (range > 250 mi) = {hi_range_elec_vehicles}")
