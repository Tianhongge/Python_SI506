...
def main():
    ...
    # Get articles
    articles = read_json('nyt-articles-200.json') # TODO Call function
    ...
    # # print(f"\nAuthors = {authors}")
    authors_headers = ['last_name', 'first_name', 'middle_name']
    write_csv('stu-nyt-authors.csv', authors, authors_headers)
    ...
    for article in articles:
        for person in article['byline']['person']:
            ...
            val = f"{article['pub_date']} - {article['headline']}"
