...
def add_books(books, new_books):
    ...
    for new_book in new_books:
        book_dict = {
            'title': new_book[0],
            'publisher': new_book[1],
            'language': new_book[2],
            'rating': new_book[3],
            'weight_ounces': new_book[4],
            }
...
def clean_books(books):
    ...
    for book in books:
        for key in book.keys():
            if key in ('rating', 'weight_ounces'):
                book[key] = float(book[key])
            else:
                word_list = book[key].split()
                word_list[0] = word_list[0].capitalize()
                book[key] = ' '.join(word_list)
...
def get_heavy_books(books):
    ...
    for book in books:
        # for key in book.keys():
        #     if key == "weight_ounces":
        #         if book[key] > 16:
        #             heavy_books.append(book['title'])
        if book['weight_ounces'] > 16:
            heavy_books.append(book['title'])
    return heavy_books
...
def add_weight_category(books):
    ...
    heavy_books = get_heavy_books(books)
    for book in books:
        if book['title'] in heavy_books:
            book['weight'] = 'heavy'
        else:
            book['weight'] = 'light'
...
def main():
    ...
    # Problem 01
    print("Problem 01:\n")
    top_amazon_books = read_csv_to_dicts('top_amazon_books.csv')
    print(top_amazon_books)


    # Problem 02
    print("Problem 02:\n")
    add_books(top_amazon_books, new_books)
    print(top_amazon_books)


    # Problem 03
    print("Problem 03:\n")
    clean_books(top_amazon_books)
    print(top_amazon_books)


    # Problem 04
    print("Problem 04:\n")
    heavy_book_list = get_heavy_books(top_amazon_books)
    print(heavy_book_list)


    # Problem 05
    print("Problem 05:\n")
    add_weight_category(top_amazon_books)
    print(top_amazon_books)


    # Problem 06
    print("Problem 06:\n")
    fieldnames = top_amazon_books[0].keys()
    write_dicts_to_csv('stu_updated_amazon_books.csv', top_amazon_books, fieldnames)
