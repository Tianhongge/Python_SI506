...
def main():
    ...
    # Problem 01 (5 points)
    print("Problem 01:\n")
    swapi_millennium_falcon = get_swapi_resource(ENDPOINT + '/starships', {'search': 'falcon'})['results'][0]
    ...
    # Problem 03 (4 points)
    print("Problem 03:\n")
    swapi_chewie = get_swapi_resource(ENDPOINT + '/people', {'search': 'chewbacca'})['results'][0]
    swapi_han_solo = get_swapi_resource(ENDPOINT + '/people', {'search': 'han solo'})['results'][0]
    ...
    for passenger in passengers:
        swapi_passenger = get_swapi_resource(ENDPOINT + '/people', {'search': passenger})['results'][0]
