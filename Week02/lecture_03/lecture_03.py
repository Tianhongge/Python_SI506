...
uniqname_count = None # TODO call function
# TODO Uncomment
...
# ratio
student_teacher_ratio = student_count / (lecturer_count + gsi_count)
print(f"\n6.2.1 Student:Teacher ratio = {student_teacher_ratio}")

# Max enrolled percentage
max_enrolled_pct = student_count / max_enrollment
