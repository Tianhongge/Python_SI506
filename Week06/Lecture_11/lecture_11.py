...
lucky_charms = get_cereal(cereals, 'lucky charms') # TODO Call function
...
raisin_bran = get_cereal(cereals, 'raisin bran') # TODO Call function
...
for cereal in cereals:
    ...
    string = f"{cereal[0]} rating: favorable={fav}, neutral={neutral}, unfavorable={unfav}"
...
cheerios = get_cereal(cereal, 'cheerios') # TODO Call function
cheerios_fav_pct = compute_favorability_rating(cheerios) # TODO Call function
