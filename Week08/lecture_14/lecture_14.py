...
def main():
    ...
    # CHALLENGE 01
    path_wash = 'E:\Coding\Python3.10\SI506\Week08\lecture_14\mi-covid-washtenaw-202111.csv'

    wash_data = read_csv(path_wash) # TODO Assign

    print(f"\nChallenge 01 Washtenaw Cty Community Spead\n{wash_data}")

    max_pos_tests = wash_data[-2] # TODO Assign

    print(max_pos_tests)

    week_02 = wash_data[7:14] # TODO Assign

    print(f"\nChallenge 01: Nov. week 02 data = {week_02} ")

    # Reverse order (includes header row)
    reverse_order = wash_data[::-1] # TODO Assign

    print(f"\nChallenge 01: Reverse order = {reverse_order}")

    # BONUS
    days_len = len(wash_data)
    wash_data_reversed = wash_data[days_len:0:-1]
    wash_data_reversed.insert(0, wash_data[0])
    ...
    path_vax = 'E:\Coding\Python3.10\SI506\Week08\lecture_14\mi-covid-vax_counties-202111.csv'
    vax_data = read_csv(path_vax) # TODO Call function
    ...
    washtenaw_cty = get_county(vax_counties, 'washtenaw county') # TODO Call function
    ...
    washtenaw_cty_vax_complete_pct = get_attribute(washtenaw_cty, vax_headers, 'Series_Complete_Pop_Pct') # Call function
    ...
    outliers = []# Implement loop, accumulator list
    for county in vax_counties:
    ...
    path_nchs = 'E:\Coding\Python3.10\SI506\Week08\lecture_14\mi-nchs-urban_rural_codes.csv'
    nchs_codes_data = read_csv(path_nchs) # TODO Call function
